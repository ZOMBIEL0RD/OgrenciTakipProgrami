...
namespace Nesne_2_OGRENCI_TAKIP_1.Forms
{
    public partial class FrmStudent : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Öğrenci Numarası Zaten Kayıtlı!", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            db.SaveChanges();
            MessageBox.Show("Öğrenci Kaydedildi!", "Tamam", MessageBoxButtons.OK, MessageBoxIcon.Information);
            GetStudentList();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            MessageBox.Show("Öğrenci Güncelleme Başarılı!", "Tamam", MessageBoxButtons.OK, MessageBoxIcon.Information);
            GetStudentList();
            btnClear.PerformClick();
        }
